...
public class Application {
    ...
    // Remplacement du DAO par le Service (Architecture 3 couches)
    ...
    private static void handleTasks(HttpExchange exchange) throws IOException {
        ...
        // GET /tasks/count (Bonus) - Placé en premier pour éviter les conflits
        ...
        if ("GET".equals(method) && "/tasks".equals(path)) {
            ...
            Collection<Task> tasks = taskService.getAllTasks(todoOnly);
