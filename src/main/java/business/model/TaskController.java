package business.model; // Le package devient 'business' et non 'business.model'

import business.JsonUtils;   // On importe les outils du dossier parent
import business.Application; // Idem
